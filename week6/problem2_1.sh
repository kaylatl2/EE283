...
file="/pub/kaylatl2/EE283/week6/helpfiles/prefixes_A7_WD.txt"
...
java -jar /opt/apps/picard-tools/2.27.1/picard.jar MarkDuplicates \
        I=$SourceDir/${prefix}.sort.bam \
        O=$DestDir/${prefix}.ATAC.dedup.bam \
        M=$DestDir/${prefix}.test.marked_dup_metrics.txt \
	REMOVE_DUPLICATES=true

samtools index $DestDir/${prefix}.ATAC.dedup.bam $DestDir/${prefix}.ATAC.dedup.bam.bai
